<form name="sikshya-prev-question" class="sikshya-prev-question-form" method="post">
    ...
    <input type="hidden" value="sikshya_prev_quiz_question" name="sikshya_action"/>
    <input type="hidden" value="sikshya_notice" name="sikshya_prev_quiz_question"/>
    <input type="hidden" value="<?php echo wp_create_nonce('wp_sikshya_prev_quiz_question_nonce') ?>"
           name="sikshya_nonce"/>
