...
<div class="sikshya-lesson-form-tabs">
    ...
    <div class="sikshya-tabs-sidebar">
        <div class="sikshya-tabs-nav">
            <button type="button" class="sikshya-tab-btn active" data-tab="quiz">
            ...
            <button type="button" class="sikshya-tab-btn" data-tab="questions">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="sikshya-tabs-content">
        <!-- Tab 1: Quiz -->
        <div class="sikshya-tab-panel active" id="quiz" data-tab="quiz">
            <div class="sikshya-form-section">
                ...
                <div class="sikshya-form-row-small">
                    ...
                    <input type="text" id="quiz-lesson-title" name="title" placeholder="Enter quiz title" required>
                </div>
                
                <div class="sikshya-form-row-small">
                    <label>Course *</label>
                    <select id="quiz-lesson-course" name="course_id" required>
                ...
                <div class="sikshya-form-row-small">
                    ...
                    <textarea id="quiz-lesson-description" name="description" placeholder="Brief description of this quiz"></textarea>
                </div>
                
                <div class="sikshya-form-grid-2">
                    <div class="sikshya-form-row-small">
                        <label>Time Limit (minutes)</label>
                        <input type="number" id="quiz-lesson-duration" name="duration" placeholder="30" min="1">
                    </div>
                    
                    <div class="sikshya-form-row-small">
                        <label>Difficulty Level</label>
                        <select id="quiz-lesson-difficulty" name="difficulty">
        ...
        <!-- Tab 2: Questions -->
        <div class="sikshya-tab-panel" id="questions" data-tab="questions">
            <div class="sikshya-form-section">
        ...
        <div class="sikshya-tab-panel" id="settings" data-tab="settings">
            <div class="sikshya-form-section">
                ...
                <div class="sikshya-form-grid-2">
                    <div class="sikshya-form-row-small">
                        ...
                        <select id="quiz-lesson-type" name="quiz_type">
                    ...
                    <div class="sikshya-form-row-small">
                        ...
                        <input type="number" id="quiz-lesson-passing" name="passing_score" placeholder="70" min="0" max="100">
                    </div>
                </div>
                ...
                <div class="sikshya-form-grid-2">
                    <div class="sikshya-form-row-small">
                        ...
                        <select id="quiz-lesson-attempts" name="attempts_allowed">
                    ...
                    <div class="sikshya-form-row-small">
                        ...
                        <select id="quiz-lesson-results" name="show_results">
                ...
                <div class="sikshya-form-grid-2">
                    <div class="sikshya-form-row-small">
                        ...
                        <select id="quiz-lesson-randomize" name="randomize_questions">
                    ...
                    <div class="sikshya-form-row-small">
                        ...
                        <select id="quiz-lesson-show-answers" name="show_correct_answers">
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                    </div>
            ...
            <div class="sikshya-form-section">
                ...
                <div class="sikshya-form-row-small">
                    ...
                    <textarea id="quiz-lesson-instructions" name="instructions" placeholder="Provide clear instructions for students taking this quiz"></textarea>
                </div>
                
                <div class="sikshya-form-row-small">
                    <label>Learning Objectives</label>
                    <textarea id="quiz-lesson-objectives" name="objectives" placeholder="What will this quiz assess?"></textarea>
                </div>
                
                <div class="sikshya-form-row-small">
                    <label>Prerequisites</label>
                    <textarea id="quiz-lesson-prerequisites" name="prerequisites" placeholder="What should students know before taking this quiz?"></textarea>
                </div>
            </div>
            ...
            <div class="sikshya-form-section">
                ...
                <div class="sikshya-form-grid-2">
                    <div class="sikshya-form-row-small">
                        ...
                        <input type="datetime-local" id="quiz-lesson-due-date" name="due_date">
                    </div>
                    
                    <div class="sikshya-form-row-small">
                        <label>Available From</label>
                        <input type="datetime-local" id="quiz-lesson-available-from" name="available_from">
                    </div>
                </div>
                ...
                <div class="sikshya-form-grid-2">
                    <div class="sikshya-form-row-small">
                        ...
                        <input type="datetime-local" id="quiz-lesson-available-until" name="available_until">
                    </div>
                    
                    <div class="sikshya-form-row-small">
                        <label>Require Password</label>
                        <input type="text" id="quiz-lesson-password" name="password" placeholder="Leave empty for no password">
                    </div>
                </div>
                ...
                <div class="sikshya-form-grid-2">
                    <div class="sikshya-form-row-small">
                        ...
                        <select id="quiz-lesson-backtrack" name="allow_backtracking">
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                    </div>
                    ...
                    <div class="sikshya-form-row-small">
                        ...
                        <select id="quiz-lesson-progress" name="show_progress_bar">
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                    </div>
                ...
                <div class="sikshya-form-grid-2">
                    <div class="sikshya-form-row-small">
                        ...
                        <select id="quiz-lesson-completion" name="require_completion">
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                    </div>
                    ...
                    <div class="sikshya-form-row-small">
                        ...
                        <select id="quiz-lesson-notifications" name="send_notifications">
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                    </div>
                ...
                <div class="sikshya-form-row-small">
                    <label>Tags</label>
                    <input type="text" id="quiz-lesson-tags" name="tags" placeholder="Enter tags separated by commas">
                </div>
            </div>
        </div>
    </div>
