...
<div class="sikshya-lesson-form-tabs">
    ...
    <div class="sikshya-tabs-content">
        <!-- Tab 1: Basic & Content -->
        <div class="sikshya-tab-panel active" id="basic-content">
        ...
        <div class="sikshya-tab-panel" id="media-resources">
            <div class="sikshya-form-section">
        ...
        <!-- Tab 3: Settings -->
        <div class="sikshya-tab-panel" id="settings">
            <div class="sikshya-form-section">
        ...
        <!-- Tab 4: Advanced -->
        <div class="sikshya-tab-panel" id="advanced">
            <div class="sikshya-form-section">
