<div class="ms-field ms-field-large js-sikshya__quiz-question-answer-item">
    ...
    <div class="ms-value">
        <div<?php if ($question_type !== 'single' && $question_type !== 'multi') { ?> style="display: none;" <?php } ?>
            ...
            <input type="text" id="quiz_question_answer<?php echo $id; ?>_value" name="<?php echo $name; ?>[value]"
                   size="25" value="<?php echo esc_attr($value); ?>"/>
        ...
        <div>
            <label><input
                    ...
                    name="<?php echo $name_correct; ?>" class="js-sikshya__quiz-question-answer_correct"
                    value="<?php echo esc_attr($answer_id); ?>"<?php if (in_array($answer_id, $data_correct)) { ?> checked="checked"<?php } ?>> <?php _e('Correct answer', 'sikshya'); ?>
            </label>
        </div>
    </div>
</div>