...
if (class_exists('Sikshya_Admin_List_Table_Sections', false)) {
	return;
}
...
/**
 * Sikshya_Admin_List_Table_Sections Class.
 */
class Sikshya_Admin_List_Table_Sections extends Sikshya_Admin_List_Table
{
	 ...
	 * @var string
	 */
	protected $list_table_type = SIKSHYA_SECTIONS_CUSTOM_POST_TYPE;
