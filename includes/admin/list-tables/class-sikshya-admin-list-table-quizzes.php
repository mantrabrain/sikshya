...
if (class_exists('Sikshya_Admin_List_Table_Quizzes', false)) {
    return;
}
...
/**
 * Sikshya_Admin_List_Table_Quizzes Class.
 */
class Sikshya_Admin_List_Table_Quizzes extends Sikshya_Admin_List_Table
{
     ...
     * @var string
     */
    protected $list_table_type = SIKSHYA_QUIZZES_CUSTOM_POST_TYPE;
    ...
    public function define_columns($columns)
    {
        ...
        $show_columns['question'] = __('Number Of Questions', 'sikshya');
    ...
    /*
     * Render column : questions
     */

    protected function render_question_column()
    {
        $quiz_id = $this->object->ID;

        $question_count = sikshya()->question->count_by_quiz($quiz_id);

        $title = $question_count . ' questions';

        echo '<span class="sik-label-counter" title="' . esc_attr($title) . '">' . absint($question_count) . '</span>';
    }
    ...
    protected function render_course_column()
    {
        ...
        $courses = sikshya()->course->get_all_by_quiz($quiz_id);
