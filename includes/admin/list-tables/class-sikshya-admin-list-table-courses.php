...
class Sikshya_Admin_List_Table_Courses extends Sikshya_Admin_List_Table
{
	...
	protected function render_blank_state()
	{
		...
		echo '<a class="sikshya-blankstate-cta button" href="' . esc_url(admin_url('edit.php?post_type=' . SIKSHYA_COURSES_CUSTOM_POST_TYPE . '&page=course_importer')) . '">' . esc_html__('Start Import', 'sikshya') . '</a>';
