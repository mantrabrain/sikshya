...
if (!class_exists('Sikshya_Settings_Page', false)) :
    ...
    abstract class Sikshya_Settings_Page
    {
        ...
        {
            return apply_filters('sikshya_get_sections_' . $this->id, array());
        }
        ...
        public function output_sections()
        {
            ...
            foreach ($sections as $id => $label) {
                echo '<li><a href="' . admin_url('admin.php?page=sik-settings&tab=' . $this->id . '&section=' . sanitize_title($id)) . '" class="' . ($current_section == $id ? 'current' : '') . '">' . $label . '</a> ' . (end($array_keys) == $id ? '' : '|') . ' </li>';
            }
