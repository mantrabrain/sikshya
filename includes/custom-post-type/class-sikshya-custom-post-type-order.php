...
if (!class_exists('Sikshya_Custom_Post_Type_Order')) {
    ...
    class Sikshya_Custom_Post_Type_Order
    {
        ...
        {
            register_post_status('sikshya-booked', array(
                'label' => _x('Booked', 'post status label', 'sikshya'),
                'public' => true,
                'label_count' => _n_noop('Booked <span class="count">(%s)</span>', 'Booked<span class="count">(%s)</span>', 'sikshya'),
